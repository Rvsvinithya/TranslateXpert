...
root = tk.Tk()
root.title('TranslateXpert')
root.geometry('590x370')

frame1= Frame(root, width=590, height=370, relief=RIDGE, borderwidth=5, bg='#F7DC6F')
frame1.place(x=0, y=0)

Label(root, text="TranslateXpert", font=("Helvetica 20 bold"), fg="black", bg='#F7DC6F').pack(pady=10)
...
def translate():
    ...
    if lang_1 == '':
        messagebox.showerror('TranslateXpert', 'Enter the text to translate!')
    else:
        text_entry2.delete(1.0,'end')
        translator = Translator()
        output = translator.translate(lang_1, dest=c1)
